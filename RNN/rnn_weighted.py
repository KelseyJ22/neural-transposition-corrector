...
if __name__ == '__main__':
    ...
    command_parser.add_argument('-dt', '--data-train', type=argparse.FileType('r'), default='data/train_weighted_replacement', help='Training data')
    command_parser.add_argument('-dd', '--data-dev', type=argparse.FileType('r'), default='data/test_weighted_full', help='Testing data')
    command_parser.set_defaults(func=train)

    command_parser = subparsers.add_parser('evaluate', help='')
    command_parser.add_argument('-d', '--data', type=argparse.FileType('r'), default='data/test_weighted_replacement', help='Training data')
